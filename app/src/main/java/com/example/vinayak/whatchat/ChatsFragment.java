...
public class ChatsFragment extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter adapter = new FirebaseRecyclerAdapter<Conv, ConvViewHolder>(options) {
            ...
            @Override
            protected void onBindViewHolder(final ConvViewHolder holder, int position, final Conv conv) {
                final String list_user_id = getRef(position).getKey();
                Log.e("ChatsFragment ","onBindViewHolder list_user_id: " + list_user_id );
